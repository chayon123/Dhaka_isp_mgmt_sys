                    ...
                    <table class="">
                        <thead>
                            ...
                            <?php
                                    ...
                                    $status = "Subscribed";
                                    $query = "SELECT s.isp_name,s.sub_fee,s.package_speed,s.isp_id,s.package_name,s.complain,s.reply,i.user_id FROM user i JOIN subscriber_list s ON(i.user_id = s.subscriber_id)  WHERE user_id = $id";
                                    if ($result = $conn->query($query)) {
                                      printf("<br>You have %d Subcribed Packages!<br>", $result->num_rows);
